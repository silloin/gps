...
import { BookOpen, CheckCircle, Circle, ArrowRight, Play, Info } from 'lucide-react';
        ...
        {!plan ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-800 p-8 rounded-xl border border-gray-700 hover:border-blue-500 transition cursor-pointer"
              ...
              <p className="text-gray-400 mb-6">Perfect for those just starting their running journey. Focuses on endurance and consistency.</p>
            ...
            <div className="bg-gray-800 p-8 rounded-xl border border-gray-700 hover:border-green-500 transition cursor-pointer"
              ...
              <p className="text-gray-400 mb-6">Designed to help you run your first 5K with confidence. Mix of short and long runs.</p>
          ...
          <div className="bg-gray-800 rounded-xl overflow-hidden shadow-2xl border border-gray-700">
            <div className="bg-gray-700 p-6 flex justify-between items-center">
              <div>
                <h2 className="text-2xl font-bold uppercase tracking-wide">{plan.planType} Plan</h2>
                <p className="text-gray-300">Started on {new Date(plan.startDate).toLocaleDateString()}</p>
              </div>
              <button
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400">
                          {workout.distance ? `${workout.distance} km` : `${workout.duration} mins`}
                        </p>
                      </div>
                    </div>
